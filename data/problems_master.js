...
},
{
  ...
  "explanation":
    ...
    + "<br>【別解】<br>"
    + "\\(y = \\sqrt{1-x^2}\\)とすると、\\(x^2 + y^2 = 1\\)で、被積分関数は原点中心、半径\\(1\\)の円の\\(y \\ge 0\\)の部分なので、"
  ...
  "id": 32,
  "genre": "多項式関数編",
  "problem": "\\[ \\int \\frac{x^3}{\\sqrt{4+x^2}}\\,dx \\]",
  "policy": "部分積分",
  "answer": "\\[ x^2\\sqrt{4+x^2} - \\frac{2}{3}(4+x^2)\\sqrt{4+x^2}+C \\]",
  "explanation": "\\[ \\int \\frac{x^3}{\\sqrt{4+x^2}}\\,dx \\] \\[= \\int x^2\\cdot\\frac{\\boxed{x}}{\\sqrt{4+x^2}}dx \\] \\[= x^2\\sqrt{4+x^2} - \\int \\frac{2x}{\\sqrt{4+x^2}}dx \\] \\[= x^2\\sqrt{4+x^2} - \\frac{2}{3}(4+x^2)\\sqrt{4+x^2} + C \\]【解説】\\( \\dfrac{1}{\\sqrt{2次式}} \\) の積分はややこしいが、分子に \\( x \\) が1つでも乗っていれば、微分はみだし形を無理やり作ることで積分できる形となるので、残りを分離して部分積分可能。"
},{
  "id": 33,
  "genre": "多項式関数編",
  ...
  "explanation":
    ...
    + "\\[\\]"+"\\[= \\dfrac{1}{2}\\{4\\log(x + \\sqrt{4 + x^2}) + x\\sqrt{4 + x^2}\\} + C \\]"
  ...
  "explanation":
    ...
    + "<br>【別解】<br>"
    + "\\[\\int \\dfrac{1}{1 + \\cos x}\\,dx \\]"+"\\[= \\int \\dfrac{1}{2 \\cos^2 \\frac{x}{2}}\\,dx \\]"+"\\[= \\int \\dfrac{1}{\\cos^2 \\frac{x}{2}}\\cdot \\dfrac{1}{2}\\,dx \\]"+"\\[= \\tan \\dfrac{x}{2} + C\\]"
  ...
  "explanation":
    ...
    + "<br>【別解】<br>"
    + "\\[\\int \\tan^3 x\\,dx \\]"+"\\[= \\int \\dfrac{\\sin^3 x}{\\cos^3 x}\\,dx \\]"+"\\[= \\int \\left(\\dfrac{1}{\\cos^3 x} - \\dfrac{1}{\\cos x}\\right)\\boxed{\\sin x}\\,dx\\]"
    + "\\[\\]"+"\\[= \\dfrac{1}{2 \\cos^2 x} + \\log|\\cos x| + C\\]"
  ...
  "explanation":
    ...
    + "<br>【別解】<br>"
    + "\\[\\int \\dfrac{1}{\\sin x}\\,dx \\]"+"\\[= \\int \\dfrac{1}{2 \\sin \\dfrac{x}{2} \\cos \\dfrac{x}{2}}\\,dx \\]"+"\\[= \\int \\dfrac{1}{2 \\tan \\dfrac{x}{2}} \\cdot \\boxed{ \\dfrac{1}{ \\cos^2 \\dfrac{x}{2}}}\\,dx \\]"+"\\[= \\log\\left|\\tan \\dfrac{x}{2}\\right| + C\\]"
  ...
  "explanation":
    ...
    + "<br>【別解】<br>"
    + "\\[\\int_{0}^{2\\pi} \\sqrt{1 + \\cos x}\\,dx \\]"+"\\[= \\int_{0}^{2\\pi} \\sqrt{2\\cos^2 \\frac{x}{2}}\\,dx \\]"+"\\[= \\sqrt{2} \\int_{0}^{2\\pi} \\left|\\cos \\frac{x}{2}\\right|\\,dx\\]"
  ...
  "explanation":
    ...
    + "<br>【別解】<br>"
    + "\\[\\int_{0}^{\\frac{\\pi}{2}} \\sin^2 x\\,dx \\]"+"\\[= \\int_{0}^{\\frac{\\pi}{2}} \\dfrac{1 - \\cos 2x}{2}\\,dx \\]"+"\\[= \\left[\\dfrac{1}{2}x - \\dfrac{1}{4}\\sin 2x\\right]_{0}^{\\frac{\\pi}{2}} \\]"+"\\[= \\dfrac{\\pi}{4}\\]"
  ...
  "explanation":
    ...
    + "<br>【別解】<br>"
    + "\\[\\int_{0}^{\\frac{\\pi}{2}} \\sin^3 x\\,dx \\]"+"\\[= \\int_{0}^{\\frac{\\pi}{2}} \\dfrac{1}{4}(3\\sin x - \\sin 3x)\\,dx \\]"+"\\[= \\dfrac{1}{4}\\left[-3\\cos x + \\dfrac{1}{3}\\cos 3x\\right]_{0}^{\\frac{\\pi}{2}} \\]"+"\\[= \\dfrac{2}{3}\\]"
  ...
  "explanation":
    ...
    + "<br>【別解】<br>"
    + "\\[F = \\int e^x \\sin 2x\\,dx\\text{、}G = \\int e^x \\cos 2x\\,dx\\text{とすると、}\\]"
    + "\\[F = e^x \\sin 2x - 2\\int e^x \\cos 2x\\,dx \\]"+"\\[= e^x \\sin 2x - 2G \\]"
    + "\\[G = e^x \\cos 2x + 2\\int e^x \\sin 2x\\,dx \\]"+"\\[= e^x \\cos 2x + 2F \\]"
    + "\\(\\text{これを解いて、}\\) "
  ...
  "explanation":
    ...
    + "【解説】(指数関数)\\(\\times\\)(三角関数)は部分積分2回で同じ形が出現する。同形が出たら移項して係数を整えればよい。"
    + "<br>【別解】<br>"
    + "\\[F = \\int e^{2x} \\cos 3x\\,dx\\text{、}G = \\int e^{2x} \\sin 3x\\,dx\\text{とすると、}\\]"
    + "\\[F = \\dfrac{1}{2}e^{2x} \\cos 3x + \\dfrac{3}{2}\\int e^{2x} \\sin 3x\\,dx \\]"+"\\[= \\dfrac{1}{2}e^{2x} \\cos 3x + \\dfrac{3}{2}G \\]"
    + "\\[G = \\dfrac{1}{2}e^{2x} \\sin 3x - \\dfrac{3}{2}\\int e^{2x} \\cos 3x\\,dx \\]"+"\\[= \\dfrac{1}{2}e^{2x} \\sin 3x - \\dfrac{3}{2}F \\end{matrix}\\right\\}\\]"
    + "\\(\\text{これを解いて、}\\)"
  ...
  "explanation":
    "\\[\\int \\frac{1}{e^x + 1}\\,dx \\]"+"\\[= \\int \\frac{e^x}{e^x(e^x + 1)}\\,dx \\]"+"\\[= \\int \\left(\\frac{1}{e^x} - \\frac{1}{e^x + 1}\\right) \\boxed{e^x}\\,dx \\]"+"\\[= \\log e^x - \\log(e^x + 1) + C \\]"+"\\[= x - \\log(e^x + 1) + C \\]"
    + "<br>"
  ...
  "explanation":
    ...
    + "<br>【別解】<br>"
    + "\\(\\dfrac{1}{x^2}\\)は簡単に積分して\\(-\\dfrac{1}{x}\\)にできるので、ここを部分積分するのが最適。"
